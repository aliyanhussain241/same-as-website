    ...
    <div className="min-h-screen bg-[#FFFBF7] font-sans selection:bg-[#FF6321] selection:text-white pb-20 pt-24">
      ...
      <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-4 gap-12">
        ...
        <div className="md:col-span-3 prose prose-orange max-w-none prose-headings:text-gray-900 prose-p:text-gray-600 prose-a:text-[#FF6321]">
          <h1 className="text-4xl md:text-5xl font-extrabold text-gray-900 mb-6 tracking-tight">Terms of Service — ResumeAI User Agreement</h1>
          <p className="text-xl text-gray-600 leading-relaxed font-medium mb-4">These Terms of Service govern your use of ResumeAI and all related career tools. By using ResumeAI, you agree to these terms. Please read them carefully.</p>
          ...
          <div className="bg-orange-50 border border-orange-100 p-6 rounded-2xl mb-12">
            <p className="font-medium text-[#FF6321] m-0">In plain English: Use ResumeAI honestly and for your own career. Do not misuse the service, steal content, or violate others' rights. We provide tools in good faith and ask you to use them in good faith. Full legal details below.</p>
          </div>

          <div id="sec-1" className="mb-12 scroll-mt-32">
            <h2>1. Acceptance of Terms</h2>
            <p>By accessing or using ResumeAI (resubeat.com) and any related services, applications, or tools (collectively, the 'Service'), you agree to be bound by these Terms of Service ('Terms') and our Privacy Policy, which is incorporated into these Terms by reference.</p>
            <p>If you are using ResumeAI on behalf of an organization, company, or institution, you represent that you have the authority to bind that organization to these Terms.</p>
            <p>If you do not agree to these Terms, you may not access or use ResumeAI. Your continued use of the Service following any updates to these Terms constitutes your acceptance of the revised Terms.</p>
            <p>These Terms constitute a legally binding agreement between you ('User') and ResumeAI ('Company', 'we', 'us', 'our').</p>
          </div>

          <div id="sec-2" className="mb-12 scroll-mt-32">
            <h2>2. Description of Service</h2>
            <p>ResumeAI provides an AI-powered resume building and career tools platform, including but not limited to:</p>
            <ul>
            ...
            <p>ResumeAI reserves the right to modify, suspend, or discontinue any part of the Service at any time with or without notice. We shall not be liable to you or any third party for any modification, suspension, or discontinuation of the Service.</p>
          </div>

          <div id="sec-3" className="mb-12 scroll-mt-32">
            <h2>3. Account Registration and Security</h2>
            <ul>
              <li><strong>Creating an Account:</strong> To access certain features of ResumeAI, you must create an account by providing a valid email address and password, or by using Google or LinkedIn OAuth authentication. You must be at least 16 years of age to create a ResumeAI account.</li>
              <li><strong>Account Accuracy:</strong> You agree to provide accurate, current, and complete information during registration and to keep your account information updated. ResumeAI is not responsible for problems caused by inaccurate account information.</li>
              <li><strong>Account Security:</strong> You are responsible for maintaining the confidentiality of your account credentials. You agree to notify ResumeAI immediately at support@resubeat.com if you become aware of any unauthorized use of your account or any security breach.</li>
          ...
          <div id="sec-4" className="mb-12 scroll-mt-32">
            ...
            <ul>
              <li><strong>Free Plan:</strong> ResumeAI offers a free plan that allows users to create, edit, and preview resumes with core functionality. Free plan users may create up to 3 resumes and access basic templates. Free plan features may be modified at any time.</li>
              <li><strong>Pro Subscription:</strong> ResumeAI Pro is a paid subscription that unlocks unlimited resumes, premium templates, PDF and DOCX downloads, the cover letter generator, advanced ATS analysis, and other premium features. Pro pricing is displayed on our Pricing page and may change with 30 days notice to existing subscribers.</li>
              <li><strong>Billing:</strong> Pro subscriptions are billed monthly or annually in advance. Payments are processed securely by Stripe. By subscribing to Pro, you authorize ResumeAI to charge your payment method on a recurring basis until you cancel.</li>
              ...
              <li><strong>Refunds:</strong> We offer a full refund within 7 days of your initial Pro subscription purchase if you are not satisfied. After 7 days, refunds are evaluated on a case-by-case basis. Contact billing@resubeat.com to request a refund.</li>
              <li><strong>Free Trial:</strong> If ResumeAI offers a free trial of Pro features, your payment method will be charged at the end of the trial period unless you cancel before the trial expires. Trial terms will be clearly stated at sign-up.</li>
            </ul>
          </div>

          <div id="sec-5" className="mb-12 scroll-mt-32">
            <h2>5. Acceptable Use Policy</h2>
            <p>You agree to use ResumeAI only for lawful purposes and in accordance with these Terms. You agree NOT to:</p>
            <ul>
              <li><strong>Misrepresent Information:</strong> Use ResumeAI to create resumes containing deliberately false, fabricated, or misleading work experience, qualifications, certifications, or educational credentials. While ResumeAI helps you present your real experience powerfully, we do not support fraud or misrepresentation.</li>
              ...
              <li><strong>Abuse the Service:</strong> Attempt to gain unauthorized access to ResumeAI systems, reverse engineer the AI models, scrape resume data at scale, or use automated bots to access the Service.</li>
              <li><strong>Harm Others:</strong> Use ResumeAI to harass, impersonate, or harm other users, or to generate content that is defamatory, threatening, or discriminatory.</li>
              ...
              <li><strong>Commercial Resale:</strong> Resell, redistribute, or sublicense access to ResumeAI without written permission from ResumeAI.</li>
            </ul>
          ...
          <div id="sec-6" className="mb-12 scroll-mt-32">
            ...
            <ul>
              <li><strong>ResumeAI's Intellectual Property:</strong> The ResumeAI platform, including its design, code, AI models, resume templates, example library, written content, logos, and trademarks, is owned by ResumeAI and protected by copyright, trademark, and other intellectual property laws. You may not copy, reproduce, distribute, or create derivative works from ResumeAI's proprietary content without written permission.</li>
              <li><strong>Your Content:</strong> You retain full ownership of the personal content you provide to ResumeAI — including your work history, skills, education, and contact details. By using ResumeAI, you grant us a limited, non-exclusive license to process and store your content solely for the purpose of providing the Service to you.</li>
          ...
          <div id="sec-7" className="mb-12 scroll-mt-32">
            ...
            <p>ResumeAI uses artificial intelligence to generate resume content, cover letters, and interview preparation materials. By using our AI tools, you acknowledge and agree to the following:</p>
            <ul>
              ...
              <li><strong>Accuracy:</strong> AI-generated content reflects general best practices for resume writing. It does not constitute legal, career, financial, or professional advice. ResumeAI does not guarantee that any AI-generated resume will result in interviews, job offers, or employment.</li>
          ...
          <div id="sec-8" className="mb-12 scroll-mt-32">
            ...
            <p>TO THE FULLEST EXTENT PERMITTED BY APPLICABLE LAW, RESUMEAI DISCLAIMS ALL WARRANTIES, EXPRESS OR IMPLIED, INCLUDING BUT NOT LIMITED TO:</p>
            <ul>
            ...
            <p>ResumeAI does not warrant that your resume will pass any particular ATS system, result in interviews, or lead to employment. ATS systems vary by employer and are updated frequently. Our ATS scores are estimates based on general ATS behavior patterns and are not guarantees of actual ATS performance.</p>
          </div>

          <div id="sec-9" className="mb-12 scroll-mt-32">
            <h2>9. Limitation of Liability</h2>
            <p>TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, RESUMEAI AND ITS OFFICERS, DIRECTORS, EMPLOYEES, AND AGENTS SHALL NOT BE LIABLE FOR:</p>
            <ul>
              ...
              <li>Any damages exceeding the total amount you paid to ResumeAI in the 12 months preceding the claim</li>
            </ul>
            ...
            <p>Nothing in these Terms limits ResumeAI's liability for fraud, gross negligence, willful misconduct, or any liability that cannot be excluded under applicable law.</p>
          </div>

          <div id="sec-10" className="mb-12 scroll-mt-32">
            <h2>10. Termination</h2>
            <ul>
              <li><strong>Termination by You:</strong> You may terminate your ResumeAI account at any time by going to Account Settings and selecting Delete Account. Upon deletion, your personal data and resume content will be permanently deleted within 30 days.</li>
              <li><strong>Termination by ResumeAI:</strong> ResumeAI reserves the right to suspend or terminate your account immediately, without notice or liability, if you:
                <ul>
                  ...
                  <li>Attempt to harm the Service, other users, or ResumeAI</li>
                </ul>
              </li>
          ...
          <div id="sec-11" className="mb-12 scroll-mt-32">
            ...
            <ul>
              ...
              <li><strong>Informal Resolution:</strong> Before filing any formal legal claim, you agree to contact ResumeAI at legal@resumeai.com to attempt to resolve the dispute informally. We will make good faith efforts to resolve disputes within 30 days.</li>
              <li><strong>Arbitration:</strong> If informal resolution fails, any dispute arising from these Terms or your use of ResumeAI shall be resolved through binding individual arbitration administered by the American Arbitration Association (AAA) under its Consumer Arbitration Rules. You waive your right to participate in class action lawsuits.</li>
          ...
          <div id="sec-12" className="mb-12 scroll-mt-32">
            ...
            <p>ResumeAI reserves the right to update these Terms of Service at any time. When we make material changes, we will:</p>
            <ul>
              <li>Update the 'Last Updated' date at the top of this page</li>
              <li>Send an email notification to all registered users at least 14 days before the changes take effect</li>
              <li>Display a prominent notice on the ResumeAI platform</li>
            </ul>
            ...
            <p>Your continued use of ResumeAI after the effective date of updated Terms constitutes your acceptance of those Terms. If you do not agree to the updated Terms, you must stop using the Service and delete your account before the effective date.</p>
          </div>
          ...
          <div id="sec-13" className="mb-12 scroll-mt-32">
            ...
            <ul>
              <li><strong>General Terms Questions:</strong> support@resumeai.com</li>
              <li><strong>Legal Notices:</strong> legal@resumeai.com</li>
              <li><strong>Privacy Matters:</strong> privacy@resumeai.com</li>
              <li><strong>Billing Disputes:</strong> billing@resumeai.com</li>
              <li><strong>Response Time:</strong> We respond to all legal and compliance inquiries within 5 business days.</li>
            </ul>
            <br />
            <p>
              <strong>Mailing Address:</strong><br />
              ResumeAI Legal Department<br />
              [Company Address]<br />
              [City, State, ZIP]<br />
              United States
            </p>
  ...
  return (
    <div className="min-h-screen bg-[#FFFBF7] font-sans selection:bg-[#FF6321] selection:text-white pb-20 pt-24">
      <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-4 gap-12">
        ...
        <div className="md:col-span-3 prose prose-orange max-w-none prose-headings:text-gray-900 prose-p:text-gray-600 prose-a:text-[#FF6321]">
          <h1 className="text-4xl md:text-5xl font-extrabold text-gray-900 mb-6 tracking-tight">Privacy Policy — How ResumeAI Protects Your Data</h1>
          <p className="text-xl text-gray-600 leading-relaxed font-medium mb-4">Your privacy is not a checkbox for us — it is a core part of how we build ResumeAI. We never sell your data, never share your resume with employers, and give you full control over your information.</p>
          ...
          <div id="sec-1" className="mb-12 scroll-mt-32">
            ...
            <p>When you create a ResumeAI account or use our resume builder, we collect the following information that you provide directly:</p>
            <ul>
              <li><strong>Account Information:</strong> Your name, email address, and password when you register for a ResumeAI account. If you sign up using Google or LinkedIn OAuth, we receive your name and email from those services only.</li>
              ...
              <li><strong>Payment Information:</strong> If you subscribe to ResumeAI Pro, your payment is processed by Stripe. We never see or store your full credit card number. We receive only a payment confirmation token and your billing address from Stripe.</li>
            ...
            <p>When you use ResumeAI, we automatically collect certain technical information:</p>
            <ul>
              <li><strong>Usage Data:</strong> Pages visited, features used, buttons clicked, time spent on each section, and which tools you use within ResumeAI. This helps us understand how people use our service and improve it.</li>
              <li><strong>Device and Browser Data:</strong> Your browser type, operating system, screen resolution, and device type. We use this to ensure ResumeAI works correctly across all devices.</li>
          ...
          <div id="sec-3" className="mb-12 scroll-mt-32">
            ...
            <ul>
              <li><strong>Encryption:</strong> All data transmitted between your browser and ResumeAI is encrypted using TLS 1.3 (HTTPS). Your resume data stored on our servers is encrypted at rest using AES-256 encryption — the same standard used by banks and government agencies.</li>
              <li><strong>Server Security:</strong> ResumeAI is hosted on Amazon Web Services (AWS) with enterprise-grade security configurations, automatic backup systems, and 99.9% uptime guarantees. Our servers are located in the United States and the European Union.</li>
              <li><strong>Access Controls:</strong> Only authorized ResumeAI engineers with a legitimate business need can access user data, and only through secure authenticated channels with full audit logging. No ResumeAI employee can access your resume content without your permission.</li>
          ...
          <div id="sec-4" className="mb-12 scroll-mt-32">
            ...
            <p><strong>What Are Cookies:</strong> Cookies are small text files stored on your device by your browser. ResumeAI uses cookies to keep you logged in, remember your preferences, and understand how our service is used.</p>
            <h3>Types of Cookies We Use:</h3>
            <ul>
              <li><strong>Essential Cookies (Required):</strong> These cookies are necessary for ResumeAI to function. They keep you logged into your account and prevent cross-site request forgery attacks. You cannot disable these while using our service.</li>
              <li><strong>Analytics Cookies (Optional):</strong> We use Google Analytics and a self-hosted analytics tool to understand how users navigate ResumeAI, which features are most used, and where users encounter problems. This data is aggregated and anonymized. You can opt out of analytics cookies in your Account Settings.</li>
            ...
            <p><strong>How to Control Cookies:</strong> You can manage cookies through your browser settings at any time. Note that disabling essential cookies will prevent you from staying logged into your ResumeAI account.</p>
          </div>

          <div id="sec-5" className="mb-12 scroll-mt-32">
            <h2>5. Third Party Services We Use</h2>
            <p>ResumeAI uses a small number of trusted third-party services to operate our platform. Each has been evaluated for privacy compliance:</p>
            <ul>
          ...
          <div id="sec-6" className="mb-12 scroll-mt-32">
            ...
            <ul>
              <li><strong>Right to Access:</strong> You can request a complete export of all personal data we hold about you at any time. Email privacy@resumeai.com with 'Data Access Request' in the subject line and we will send your data within 30 days.</li>
              <li><strong>Right to Deletion:</strong> You can delete your ResumeAI account and all associated data at any time from Account Settings → Delete Account. We permanently delete your data within 30 days. This includes your resume content, account information, and usage history.</li>
              ...
              <li><strong>Right to Portability:</strong> You can export your resume data in PDF or DOCX format at any time from the resume builder. You can also request a JSON export of your raw account data by contacting privacy@resumeai.com.</li>
            ...
            <p>To exercise any of these rights, contact us at privacy@resumeai.com. We respond to all privacy requests within 30 days.</p>
          </div>

          <div id="sec-7" className="mb-12 scroll-mt-32">
            <h2>7. Children's Privacy</h2>
            <p>ResumeAI is designed for adults and professional job seekers. Our service is not directed at children under the age of 16. We do not knowingly collect personal information from anyone under 16 years of age.</p>
            <p>If you are a parent or guardian and believe your child has provided personal information to ResumeAI, please contact us immediately at privacy@resumeai.com. We will delete the information promptly upon verification.</p>
          </div>

          <div id="sec-8" className="mb-12 scroll-mt-32">
            <h2>8. International Data Transfers</h2>
            <p>ResumeAI is operated from the United States. If you are accessing our service from outside the United States — including from the European Union, United Kingdom, Canada, Pakistan, India, Australia, or any other country — your data will be transferred to and processed in the United States.</p>
          ...
          <div id="sec-9" className="mb-12 scroll-mt-32">
            ...
            <ul>
              <li>Update the 'Last Updated' date at the top of this page</li>
              <li>Send an email notification to all registered ResumeAI users</li>
              <li>Display a notice on the ResumeAI homepage for 30 days after the change</li>
            </ul>
            <p>We encourage you to review this Privacy Policy periodically. Your continued use of ResumeAI after changes are posted constitutes your acceptance of the updated policy.</p>
          ...
          <div id="sec-10" className="mb-12 scroll-mt-32">
            ...
            <ul>
              <li><strong>Email:</strong> privacy@resumeai.com</li>
    ...
    <div className="min-h-screen bg-[#FFFBF7] font-sans selection:bg-[#FF6321] selection:text-white pb-20 pt-24">
      ...
      <div className="max-w-4xl mx-auto px-6">
        <div className="text-center mb-16">
          <h1 className="text-4xl md:text-5xl font-extrabold text-gray-900 mb-6 tracking-tight">Contact ResumeAI — We Are Here to Help</h1>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-20">
          ...
          <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm text-center">
            ...
            <a href="mailto:billing@resumeai.com" className="block text-[#FF6321] font-bold text-sm w-full py-2 bg-orange-50 hover:bg-orange-100 rounded-lg transition-colors mb-2">Email Billing Team</a>
          ...
          <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm text-center">
            ...
            <p className="text-gray-500 text-sm mb-4">Interested in partnering with ResumeAI, featuring us in an article, or exploring integration opportunities?</p>
            <a href="mailto:partnerships@resumeai.com" className="block text-[#FF6321] font-bold text-sm w-full py-2 bg-orange-50 hover:bg-orange-100 rounded-lg transition-colors mb-2">Email Partnerships</a>
        ...
        <h2 className="text-3xl font-bold text-gray-900 mb-8">ResumeAI Company Information</h2>
        <div className="grid md:grid-cols-3 gap-6 mb-20">
          ...
          <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
            ...
            <ul className="text-sm text-gray-600 space-y-2">
              <li>Twitter/X: @ResumeAI</li>
              <li>LinkedIn: /company/resumeai</li>
              <li>YouTube: /ResumeAI</li>
              <li>Product Hunt: ResumeAI</li>
            </ul>
          </div>
        </div>
        ...
        <div className="space-y-4 mb-20">
          {[
            { q: "Is ResumeAI completely free to use?", a: "Our core AI resume builder is free to use with no credit card required. You can create, edit, and preview your resume for free. Our Pro plan unlocks unlimited downloads, premium templates, the cover letter generator, and advanced ATS analysis. You can upgrade at any time from your account dashboard." },
            { q: "How do I download my resume as a PDF?", a: "Once you have built your resume in the ResumeAI builder, click the Download button in the top right corner of the editor. Free users can download one resume as a PDF. Pro users can download unlimited resumes in both PDF and DOCX format. If your download is not working, try using Google Chrome and disabling any ad blockers." },
            { q: "Can I cancel my Pro subscription at any time?", a: "Yes. You can cancel your ResumeAI Pro subscription at any time from your Account Settings page under Billing. Your Pro access continues until the end of your current billing period. We do not charge cancellation fees. If you have any trouble cancelling, email billing@resumeai.com and we will process it within 2 hours." },
            ...
            { q: "How do I reset my password?", a: "Click Sign In on the ResumeAI homepage, then click Forgot Password below the login form. Enter your registered email address and we will send you a password reset link within 5 minutes. Check your spam folder if you do not see it. If you still have trouble accessing your account, contact support@resumeai.com." },
            { q: "Do you offer refunds?", a: "We offer a full refund within 7 days of your first Pro subscription payment if you are not satisfied — no questions asked. After 7 days, refunds are considered on a case-by-case basis. Contact billing@resumeai.com with your account email and order details to request a refund." },
            { q: "Can I use ResumeAI for multiple resumes?", a: "Yes. Free users can create and save up to 3 resumes. Pro users can create unlimited resumes and tailor each one to a different job description. This is especially useful for job seekers applying to multiple roles or industries simultaneously." }
          ].map((faq, i) => (
      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          <div className="space-y-6 text-gray-600 text-lg">
            ...
            <p>
              We built ResumeAI to change that. Our AI resume builder gives every job seeker access to the same quality of resume writing that top executives pay hundreds of dollars for — in 2 minutes, for free. Whether you are writing your first resume with no experience, switching careers after 10 years, or applying for a senior leadership role, ResumeAI tailors your resume to the exact job description and ensures it passes every major ATS system.
            </p>
            <p>
        ...
        <h2 className="text-3xl font-bold text-gray-900 mb-8">The Story Behind ResumeAI — Why We Built This</h2>
        <div className="bg-white p-8 md:p-12 rounded-3xl border border-gray-100 shadow-sm space-y-6 text-gray-600 text-lg mb-24">
          <p>ResumeAI started with a frustration that millions of job seekers share.</p>
          ...
          <p>Today, ResumeAI is used by job seekers in 120+ countries — from fresh graduates applying for their first internship to senior executives targeting C-suite positions. Every resume we help create reflects our core belief: the right resume should not be a privilege. It should be a right.</p>
        </div>
        ...
        <h2 className="text-3xl font-bold text-gray-900 mb-8">The Values That Drive ResumeAI</h2>
        ...
        <h2 className="text-3xl font-bold text-gray-900 mb-2">The Team Behind ResumeAI</h2>
        <p className="text-gray-600 mb-8 text-lg">ResumeAI is built by a small, passionate team of engineers, career coaches, and product designers who have all personally experienced the frustration of the job search process.</p>
        <div className="grid md:grid-cols-3 gap-6 mb-24">
          {[
            { n: "Alex Rahman", r: "CEO & Co-Founder", d: "Former software engineer turned career coach. Helped 2,000+ professionals rewrite their resumes before building ResumeAI to scale that impact." },
            { n: "Sarah Chen", r: "Head of AI", d: "Machine learning engineer with 8 years of NLP experience. Previously built language models at a Fortune 500 tech company. Leads all AI development at ResumeAI." },
        ...
        <h2 className="text-3xl font-bold text-gray-900 mb-8">ResumeAI in the News</h2>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-24">
          {[
            { q: "I applied to 40 jobs with my old resume and heard nothing. I rebuilt it with ResumeAI in 10 minutes and got 3 interview calls in the first week. The ATS score feature showed me exactly what was wrong.", a: "James K.", r: "Software Engineer hired at Amazon" },
            { q: "As a career changer with no direct experience in marketing, I was struggling to frame my skills. ResumeAI helped me write a resume that made my background look relevant. I landed my first marketing role within 6 weeks.", a: "Priya S.", r: "Career Changer → Marketing Manager" },
            { q: "I am a nurse who had not updated my resume in 8 years. ResumeAI built me a completely modern, ATS-optimized resume in minutes. I got called for 4 interviews in 2 weeks.", a: "Lisa M.", r: "Registered Nurse, Houston" }
          ].map((t, i) => (
        ...
        <div className="bg-[#FF6321] text-white rounded-3xl p-12 text-center">
          ...
          <p className="text-orange-100 text-lg mb-8 max-w-2xl mx-auto">Join 500,000+ job seekers who have used ResumeAI to build ATS-optimized resumes, land more interviews, and get hired faster. It takes 2 minutes. It is free to start.</p>

...
head: () => ({
    ...
    meta: [
      ...
      { name: "keywords", content: "AI resume builder, free resume builder, ATS resume, resume maker, AI CV builder" },

      // Open Graph

      { property: "og:title", content: "AI Resume Builder — Free ATS-Optimized Resumes | airesumi.com" },

      { property: "og:description", content: "Build a professional, ATS-optimized resume in minutes using AI. Free, no sign-up required." },
      ...
      { name: "twitter:description", content: "Build a professional ATS-optimized resume in minutes. Free, no sign-up required." },

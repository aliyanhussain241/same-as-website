...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Free AI Resume Builder for ATS-Friendly Resumes" },
      ...
      { property: "og:title", content: "Free AI Resume Builder for ATS-Friendly Resumes" },
      ...
      { name: "twitter:title", content: "Free AI Resume Builder for ATS-Friendly Resumes" },
